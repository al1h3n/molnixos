{ pkgs, variables, ... }: {
  services.displayManager.ly = {
    ...
    settings = {
      ...
      # 1.3.5. Custom .dur file
      dur_file_path = "${variables.lshared}/images/blackhole.dur";
      ...
      brightness_down_cmd = "sh ${variables.lshared}/scripts/brightness.sh -10%";
      brightness_down_key = "F5";
      brightness_up_cmd = "sh ${variables.lshared}/scripts/brightness.sh +10%";
